title pega decimal imprime hexadecimal
.model small
.stack 100h
.data
    valor dw 0
...
main proc
    ...
    ;->Transformar para hexa decimal
                     ...
                     mov  bl,16               ;Conversão para base 16, tem que dividir para 16
                     mov  ax,valor
                     xor  dx,dx
    ...
    ;Agr tem que dar pop e se for > 9 o pop tem q transformar para letra
    ...
    loop_Imprimir:   
                     ...
                     add  dx,7                ;Transforma se for > 0 para letras
    eh_Numero:       
